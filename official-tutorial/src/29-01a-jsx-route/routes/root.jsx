...
export default function Root() {
  ...
  // See: 23-01b---explaination--how-does-search-spinner-know-when-to-show
  ...
  useEffect(() => {
    ...
    document.title = q ? `search ${q}` : 'demo'
  }, [q]);
        ...
        <div>
          ...
          >
            <input
              ...
              onChange={
                e => {
                  const userIsTyping = !(q==null)
                  submit(e.currentTarget.form, {replace: userIsTyping})
                }
              }
            />
            <div
